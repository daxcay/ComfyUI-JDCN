def split_string(main_string, search_string, from_rear=False, occurrence=1):
    if from_rear:
...
class JDCN_SplitString:
    ...
    def dosplitit(self, MainString, SearchFor, StartFrom, Occurence):
        ...
        suffix, prefix, foundat = split_string(
            MainString, SearchFor, from_rear, Occurence)
